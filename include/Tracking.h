...
public:
	...
	//Special Tracking for MonoPainter
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, MonoPainter::PainterObject* AnyPainter);
	...
	//Special  Grab function for MonoPainter
	cv::Mat GrabImageMonoPainter(const cv::Mat &im, const cv::Mat &mask, const double &timestamp);
...
protected:
    ...
    MonoPainter::PainterObject* monopainter;

public:

    MonoPainter::PainterObject* GetPainterObject();
	//void InitializeMonoPainter(MonoPainter::PainterObject* Anypainter);
};
