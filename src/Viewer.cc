...
void Viewer::Run()
{
	...
	//cerr<<"\nViewer thread: Try calling FrameDrawer..."<<endl;
	cv::Mat MonoPaintedFrame = mpFrameDrawer->GetProcessedMonoFrame();
	//cv::Mat MonoPaintedFrame = im;
	cv::imshow("MonoPainter: Processed Frame", MonoPaintedFrame);
	//cerr<<"\nViewer thread: FrameDrawer is ok!"<<endl;
